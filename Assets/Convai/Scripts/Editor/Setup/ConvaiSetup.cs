...
namespace Convai.Scripts.Editor.Setup
{
    public class ConvaiSetup : EditorWindow
    {
        ...
        private void CreatePage1()
        {
            ...
            Button docsLink = new(() => { UnityEngine.Application.OpenURL("https://docs.convai.com/api-docs/plugins-and-integrations/unity-plugin/setting-up-unity-plugin"); })
            {
        ...
        {
            UnityEngine.Application.OpenURL("https://docs.convai.com/plugins-and-integrations/unity-plugin");
        }
